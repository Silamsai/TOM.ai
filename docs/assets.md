...
Drop files into `frontend/public/assets/`. Paths are wired from `frontend/src/config/assets.js`.
...
| File | Purpose |
|------|---------|
| `hero-scene.glb` | Welcome page background |
| `mascot.glb` | Optional 3D mascot |
...
**Tech:** Three.js / React Three Fiber / Drei for GLB scenes; static files served from CRA `public/`.
