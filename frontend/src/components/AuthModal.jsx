      ...
      <div className="modal-card fade-in" role="dialog" aria-modal="true" aria-label="Sign in to tom.ai">
        ...
        <div className="modal-header">
          <div className="modal-brand">
            <InteractiveLogo width={22} height={22} style={{ verticalAlign: 'middle', marginRight: '6px', borderRadius: '5px' }} />
            tom.ai
          </div>
          <button className="modal-close" onClick={onClose} aria-label="Close" style={{ display: 'inline-flex', alignItems: 'center' }}>
            <X size={16} />
          </button>
        </div>
        ...
        {tab === 'signin' && (
          <form className="modal-form" onSubmit={handleSignIn} noValidate>
            ...
            <button id="modal-signin-btn" type="submit" className="btn btn-primary btn-full btn-lg" disabled={loading} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
          ...
          <>
            {signUpStep === 1 ? (
              <form className="modal-form" onSubmit={handleSendOTP} noValidate>
                ...
                <button id="modal-send-otp-btn" type="submit" className="btn btn-primary btn-full btn-lg" disabled={loading} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
                  {loading ? <LoadingSpinner size="small" /> : (
                    <>
              ...
              <form className="modal-form" onSubmit={handleCreateAccount} noValidate>
                ...
                <button id="modal-create-btn" type="submit" className="btn btn-primary btn-full btn-lg" disabled={loading} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
                  {loading ? <LoadingSpinner size="small" /> : (
                    <>
                ...
                <button type="button" className="btn btn-secondary btn-full" onClick={() => { setSignUpStep(1); setError(''); setSuccess(''); }} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
                  <ArrowLeft size={16} />
                  <span>Back</span>
                </button>
              </form>
