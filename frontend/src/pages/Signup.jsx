      ...
      <div className="auth-card">
        ...
        {step === 1 ? (
          <form className="auth-form" onSubmit={handleSendOTP}>
            ...
            <button id="signup-send-otp-btn" type="submit" className="btn btn-primary btn-full btn-lg" disabled={loading} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
          ...
          <form className="auth-form" onSubmit={handleVerify}>
            ...
            <button id="signup-submit-btn" type="submit" className="btn btn-primary btn-full btn-lg" disabled={loading} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
              {loading ? <LoadingSpinner size="small" /> : (
                <>
                  <Sparkles size={16} />
            ...
            <div className="spam-notice-text" style={{ fontSize: '12px', color: '#9ca3af', marginTop: '12px', lineHeight: '1.4', display: 'flex', alignItems: 'flex-start', gap: '6px' }}>
              ...
              <span>Don't see the email? Please check your <strong>Spam folder</strong>. If it's there, mark it as <strong>"Not Spam"</strong> to receive future task reminders directly in your inbox.</span>
            </div>
            <button
              type="button"
